...
<html>
  ...
  <body class="easyui-layout">
  	 <!-- Search panel start -->
 	 <div class="ui-search-panel" region="north" style="height: 80px;" title="搜索框" data-options="striped: false,collapsible:false,iconCls:'icon-search',border:false" >   
 	 <form id="searchForm">
     ...
     <!-- Edit Win&From -->
     <div id="edit-win" class="easyui-dialog" title="菜单编辑" data-options="closed:true,iconCls:'icon-save',modal:true"  style="width:500px;height:450px;">  
    	 ...
    	 <div class="easyui-panel" border='false' style="width:450px;height: 350px;">  
	        <div class="easyui-layout" data-options="fit:true">
	            <div data-options="region:'north',split:true" style="height:185px;padding:10px">  
		           ...
		           <div class="fitem">  
		               <label>排序:</label>  
		               <input class="easyui-numberbox" type="text" value="0" name="rank" data-options="required:true,min:0,max:99999">
		           </div> 
		           <div class="fitem">  
		               <label>Actions:</label>  
  ...
  <script type="text/javascript" src="${ctx}/js/ux/sys/sysMenu.js"></script>
  </body>
</html>
