     		 ...
     		 <div class="ui-edit">
	           ...
	           <div class="fitem">  
	            ...
	            <div class="fitem" style="">  
	               ...
	               <!-- 
	               <select id="menu-tree" name="menuIds" class="easyui-combotree" data-options="url:'${ctx}/sysMenu/getMenuTree.do'" multiple style="width:180px;"></select>
	                -->
	           </div>
	         </div>
     	</form>
  	 </div> 
<script type="text/javascript" src="${ctx}/js/ux/sys/sysRole.js"></script>
  </body>
</html>
