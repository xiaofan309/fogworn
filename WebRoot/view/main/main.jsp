...
<html>
  <head>
    <title>高速公路雾区智能防撞系统</title>
    <%@include file="/view/resource.jsp" %>
    <link rel="stylesheet" type="text/css" href="${ctx}/css/main.css">
    <script type="text/javascript" src="${ctx}/js/ux/main/main.js"></script>
  </head>
  <body class="easyui-layout">
	...
	<div data-options="region:'south',split:true,border:false" style="height: 30px;overflow:hidden;">
		<div class="panel-header" style="border: none;text-align: center;" >欢迎使用</div>
	</div>
	<!-- 中间内容页面 -->
