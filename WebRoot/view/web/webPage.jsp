...
<html>
  <head>
   ...
   <!-- markItUp! skin -->
	<link rel="stylesheet" type="text/css" href="${ctx}/js/markitup/skins/markitup/style.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/js/markitup/sets/default/style.css">
  </head>
  <body class="easyui-layout">
     ...
     <div id="edit-temp-win" class="easyui-dialog" title="编辑页面" buttons="#editTempBtn" data-options="closed:true,iconCls:'icon-save',modal:true,maximized:true" style="width:400px;height:300px;">  
     	...
     	<div id="editTempBtn" class="dialog-button">  
            <a href="javascript:void(0)" class="easyui-linkbutton" id="btn-temp-submit">保存</a>  
            <a href="javascript:void(0)" class="easyui-linkbutton" id="btn-temp-close">关闭</a>  
        </div>
  	 </div> 
<!-- Js Start -->
<script type="text/javascript" src="${ctx}/js/ux/web/webPage.js"></script>
<!-- markItUp! -->
<script type="text/javascript" src="${ctx}/js/markitup/jquery.markitup.js"></script>
<script type="text/javascript" src="${ctx}/js/markitup/sets/default/set.js"></script>
  </body>
</html>
